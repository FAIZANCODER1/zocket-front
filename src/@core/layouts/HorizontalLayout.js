...
import { handleMenuHidden, handleContentWidth } from '../../redux/reducer/layout'
...
console.log(themeConfig.app.appName, 'c')
  //** ComponentDidMount
  useEffect(() => {
    setIsMounted(true)
            ...
            <ul className='nav navbar-nav'>
              <NavItem>
                <Link to='/' className='navbar-brand'>
                  ...
                  <h2 className='mb-0' style={{color:'#F6A5A6'}} >{themeConfig.app.appName}</h2>
                </Link>
              </NavItem>
            </ul>
          </div>
